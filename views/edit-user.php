                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-6">
                        <?php
                            ...
                            if ($user['photo']) {
                        ?>
                            <img src="../assets/images/<?= $user['photo'] ?>" alt="<?= $user['photo'] ?>" class="d-block mx-auto edit-photo" style="width: 7em; height:7em;
                            object-fit:cover;">
                        <?php
                            }else {
                        ?>
                        ...
                        <input type="file" name="photo" class="form-control mt-2" accept="/*">
